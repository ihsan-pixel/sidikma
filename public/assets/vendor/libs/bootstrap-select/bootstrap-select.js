            ...
            ! function (e) {
                ...
                "classList" in document.createElement("_") || function (t) {
                    if ("Element" in t) {
                        ...
                        if (n.defineProperty) {
                            ...
                            try {
                                n.defineProperty(s, i, l)
                            } catch (e) {
                                void 0 !== e.number && -2146823252 !== e.number || (l.enumerable = !1, n.defineProperty(s, i, l))
                            }
                        } else n.prototype.__defineGetter__ && s.__defineGetter__(i, o)
                    }
                }(window);
                ...
                te.VERSION = "1.14.0-beta3", te.DEFAULTS = {
                    ...
                    init: function () {
                        ...
                        }), s.hasAttribute("required") && this.$element.on("invalid.bs.select", (function () {
                        ...
                        })), n && e(n).on("reset.bs.select", (function () {
                    ...
                    fetchData: function (e, t, i, s) {
                        ...
                        l ? (this.options.virtualScroll = !0, "function" == typeof l ? l.call(this, (function (i, s, l) {
                            ...
                            r.hasMore = s, r.totalItems = l, n = o.buildData(i, t), e.call(o, n), o.$element.trigger("fetched.bs.select")
                    ...
                    setSize: function (t) {
                        if (this.liHeight(t), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
                            ...
                            })), "auto" === this.options.size ? s.off("resize.bs.select." + this.selectId + ".setMenuSize scroll" + ".bs.select." + this.selectId + ".setMenuSize").on("resize.bs.select." + this.selectId + ".setMenuSize scroll" + ".bs.select." + this.selectId + ".setMenuSize", (function () {
                                return i.setMenuSize()
                            })) : this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size && s.off("resize.bs.select." + this.selectId + ".setMenuSize scroll" + ".bs.select." + this.selectId + ".setMenuSize")
                        }
                    ...
                    selectPosition: function () {
                        ...
                        })), e(window).off("resize.bs.select." + this.selectId + " scroll" + ".bs.select." + this.selectId).on("resize.bs.select." + this.selectId + " scroll" + ".bs.select." + this.selectId, (function () {
                    ...
                    clickListener: function () {
                        ...
                        i.data("spaceSelect", !1), this.$button.on("keyup", (function (e) {
                            ...
                            if (t.options.allowClear) {
                                ...
                                /MSIE|Trident/.test(window.navigator.userAgent) && (i = document.elementFromPoint(e.clientX, e.clientY)), i !== s && i.parentElement !== s || (e.stopImmediatePropagation(), function (e) {
                                    if (t.multiple) t.deselectAll();
                                        ...
                                        l && t.setSelected(l, !1), i.selectedIndex = 0, w = [n, !1, s], t.$element.triggerNative("change")
                                    }
                                    ...
                                    if (t.setSelected(r, !b), t.focusedParent.focus(), !1 !== E || !1 !== $) {
                                        ...
                                        if (E && S || $ && A)
                                            if (E && 1 === E) o.selectedIndex = -1, t.setOptionStatus(!0);
                                                ...
                                                D[2] && (L = L.replace("{var}", D[2][E > 1 ? 0 : 1]), N = N.replace("{var}", D[2][$ > 1 ? 0 : 1])), t.$menu.append(H), E && S && (H.append(e("<div>" + L + "</div>")), u = !1, t.$element.trigger("maxReached.bs.select")), $ && A && (H.append(e("<div>" + N + "</div>")), u = !1, t.$element.trigger("maxReachedGrp.bs.select")), setTimeout((function () {
                                                    t.setSelected(r, !1)
                            ...
                            t.render(), t.$element.trigger("changed.bs.select", w), w = null
                    ...
                    val: function (e) {
                        ...
                        if (void 0 !== e) {
                            ...
                            }), this), this.options.source.data && t.appendChild(this.selectpicker.main.optionQueue), this.$element.trigger("changed.bs.select", w), this.$newElement.hasClass(G.SHOW))
                    ...
                    refresh: function () {
                        ...
                        })), this.checkDisabled(), this.setStyle(), this.setWidth(), this.setSize(!0), this.$element.trigger("refreshed.bs.select")
                    },
                    hide: function () {
                ...
                function ne() {
                    if (!(V.major < 5)) return j.dataApiKeydownHandler;
                    if (e.fn.dropdown) {
